...
const cases = [
  {
    ...
    location: "Bocagrande",
    before: "Manchas visibles",
    after: "Impecable",
    beforeImage: IMAGES.sillaSucia,
    afterImage: IMAGES.sillaLimpia,
  },
  {
    title: "Sofá de sala",
    location: "Manga",
    before: "Manchas y suciedad",
    after: "Como nuevo",
    beforeImage: IMAGES.sofaSucio,
    afterImage: IMAGES.sofaLimpio,
  },
  {
    ...
    beforeImage: IMAGES.colchonSucio,
    afterImage: IMAGES.colchonLimpio,
  },
  {
    title: "Alfombra de sala",
    location: "El Laguito",
    before: "Polvo y manchas",
    after: "Fibras revitalizadas",
    beforeImage: IMAGES.alfombraSucia,
    afterImage: IMAGES.alfombraLimpia,
  },
  {
    title: "Tapete persa",
    location: "Crespo",
    before: "Suciedad incrustada",
    after: "Colores vibrantes",
    beforeImage: IMAGES.tapetePersaSucio,
    afterImage: IMAGES.tapetePersaLimpio,
  },
  {
    title: "Limpieza profunda",
    location: "Centro",
    before: "Suciedad acumulada",
    after: "Extracción total",
